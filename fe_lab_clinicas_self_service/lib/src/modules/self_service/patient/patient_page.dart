  ...
  void initState() {
    ...
    effect(() {
      if (_controller.nextStep) {
        _selfServiceController.updatePatientAndGoDocument(_controller.patient);
      }
    });
              ...
              child: Column(
                children: [
                  ...
                  TextFormField(
                    ...
                    decoration: const InputDecoration(label: Text('Digete o seu CPF')),
                  ),
                  const SizedBox(
                    height: 16,
                  ),
                  ...
                  TextFormField(
                    ...
                    decoration: const InputDecoration(
                      label: Text('Responsável identificacao'),
                    ),
                  ),
                  const SizedBox(
                    height: 32.5,
                    ...
                    replacement: SizedBox(
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          ...
                          if (valid) {
                            if (patientFound) {
                              _controller.updateAndNext(updatePatient(_selfServiceController.model.patient!));
                            } else {
                              _controller.saveAndNext(createPatientRegister());
                            }
                          }
                        },
                        child: Visibility(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: SizedBox(
                            ...
                            child: ElevatedButton(
                              onPressed: () {
                                _controller.patient = _selfServiceController.model.patient;
